      ...
      this.setState(
        {
          ...
          linesData: {},
          areasData: {},
          orphanFeatures: { status: 'success', features: [] },
          waterbodyCountMismatch: null,
          fishingInfo: { status: 'success', data: [] },
          hucBoundaries: '',
          wsioHealthIndexData: { status: 'success', data: [] },
          statesData: { status: 'success', data: [] },
          wildScenicRiversData: { status: 'success', data: [] },
          protectedAreasData: { status: 'success', data: [], fields: [] },
          countyBoundaries: '',
          monitoringLocations: { status: 'success', data: {} },
          usgsStreamgages: { status: 'success', data: {} },
          usgsDailyPrecipitation: { status: 'success', data: {} },
